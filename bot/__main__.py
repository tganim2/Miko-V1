...
async def start(client, message):
    sticker_message = await message.reply_sticker("CAACAgUAAyEFAASJpC89AANiZxxnk_zmE0xF0IVpLP6EIk1B-mQAAkwTAAKfOEFXe_QPsr_8vNYeBA")
...
async def restart(client, message):
    sticker_message = await message.reply_sticker("CAACAgUAAyEFAASJpC89AANoZxxn9v8atIpbsz76oA1xxbbXQJ4AAoMTAAJZoGFUYCdYbt_jyWseBA")
    await asyncio.sleep(1)
    await sticker_message.delete()
