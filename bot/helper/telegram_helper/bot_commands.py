...
class _BotCommands:
    def __init__(self):
        ...
        self.YtdlLeechCommand = [f'ytdl{CMD_SUFFIX}', f'yl{CMD_SUFFIX}']
        if config_dict['SHOW_EXTRA_CMDS']:
            ...
            self.YtdlCommand.extend([f'yt{CMD_SUFFIX}', f'zy{CMD_SUFFIX}'])
            self.LeechCommand.extend([f'unzipleech{CMD_SUFFIX}', f'uzl{CMD_SUFFIX}', f'zipleech{CMD_SUFFIX}', f'zl{CMD_SUFFIX}'])
            self.QbLeechCommand.extend([f'bqz{CMD_SUFFIX}', f'bqz{CMD_SUFFIX}', f'qbzl{CMD_SUFFIX}', f'qbz{CMD_SUFFIX}'])
            self.YtdlLeechCommand.extend([f'dlyt{CMD_SUFFIX}', f'ytl{CMD_SUFFIX}'])
        ...
        self.HelpCommand = f'ഹെല്പ്{CMD_SUFFIX}'
        ...
        self.SpeedCommand = [f'testspeed{CMD_SUFFIX}', f'ts{CMD_SUFFIX}']
